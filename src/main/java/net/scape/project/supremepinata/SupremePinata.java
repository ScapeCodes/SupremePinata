...
import net.scape.project.supremepinata.statistics.SQLiteStatisticsStorage;
...
public final class SupremePinata extends JavaPlugin {
    ...
    private SQLiteStatisticsStorage storage;
    ...
    public void onEnable() {
        ...
        this.storage = new SQLiteStatisticsStorage(this);
        ...
        PinataCommand command = new PinataCommand(this, messages, pinataRegistry, pinataManager, locationService, votePartyService);
